...
const YourWork = () => {
    ...
    return (
        <Card style={{
            width: '18vw', margin: '15px', border: '1px solid #06442027',
                    ...
                    <Form style = {{marginTop: '1vh'}}>
                        <Form.Group controlId="formFileMultiple" className="mb-3">
                            <Form.Control type="file" onChange={(event) => {
                                ...
                                }} style={{fontSize: '1.8vh'}} multiple/>
                        </Form.Group>
                        <div className="form-actions" style={{ marginBottom: '0.5vh' }}>
                        <Button type="submit" className = {styles.btn} classNam="btn" onClick={handleUpload}>
                            Upload
                        </Button>
                    </div>
                    </Form>
